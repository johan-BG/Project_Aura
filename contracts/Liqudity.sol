...
contract LiquidityExp is IERC721Receiver{
    ...
    uint public tokenId;
    function onERC721Received(address operator,address from,uint _tokenId,bytes calldata)external override returns(bytes4){
